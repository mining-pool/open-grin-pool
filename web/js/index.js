...
function get_pool_status() {
  ...
  xhr.onload = function () {
    ...
    if (status === 200) {
      ...
      document.getElementById("cuckatoo").innerText =
        pool.node_status.tip.total_difficulty.cuckatoo;
      document.getElementById("progpow").innerText =
        pool.node_status.tip.total_difficulty.progpow;
      document.getElementById("randomx").innerText =
        pool.node_status.tip.total_difficulty.randomx;
    } else {
